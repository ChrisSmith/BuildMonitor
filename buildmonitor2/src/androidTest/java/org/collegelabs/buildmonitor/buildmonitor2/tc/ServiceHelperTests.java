...
public class ServiceHelperTests extends AndroidTestCase {
    ...
    public void testGetEndpoint_Port() throws Exception {
        ...
        Assert.assertEquals("https://teamcity.jetbrains.com:9000/guestAuth/app/rest", ServiceHelper.getEndpoint(credentials));
    }
    ...
    public void testGetEndpoint_Pathprefix() throws Exception {
        ...
        Assert.assertEquals("https://teamcity.jetbrains.com/someprefix/guestAuth/app/rest", ServiceHelper.getEndpoint(credentials));
    }
    ...
    public void testGetEndpoint_GuestMode() throws Exception {
        ...
        Assert.assertEquals("https://teamcity.jetbrains.com/guestAuth/app/rest", ServiceHelper.getEndpoint(credentials));
    }
    ...
    public void testGetEndpoint_User() throws Exception {
        ...
        Assert.assertEquals("https://teamcity.jetbrains.com/app/rest", ServiceHelper.getEndpoint(credentials));
    }
}
